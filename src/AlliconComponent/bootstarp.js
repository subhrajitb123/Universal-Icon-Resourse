					...
					? // If there are filtered icons, render them
					  filteredIcons.map(([key, icon], index) => {
							...
							return (
								<div
									key={index}
									className="w-1/2 sm:w-1/2 md:w-1/4 lg:w-1/6 text-center py-4 flex flex-col items-center justify-center cursor-pointer flex flex-col items-center justify-center p-2 rounded-md shadow-md hover:bg-gray-100 cursor-pointer"
								>
									<svg
					...
					: // If there are no filtered icons, render all the icons
					  Object.entries(Icons).map(([key, icon], index) => {
							...
							return (
								<div
									key={index}
									className="w-1/2 sm:w-1/2 md:w-1/4 lg:w-1/6 text-center py-4 flex flex-col items-center justify-center cursor-pointer flex flex-col items-center justify-center p-4 rounded-md shadow-md hover:bg-gray-100 cursor-pointer"
								>
									<svg
