	...
	return (
		<>
			...
			<div className="flex flex-col lg:flex-row items-center justify-center  align-center">
				<div className="flex flex-col lg:flex-row items-center justify-center mx-4 align-center ">
					<svg
						viewBox="0 0 24 24"
